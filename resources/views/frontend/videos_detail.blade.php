                        ...
                        <div class="page_content">
                            ...
                            <div class="post_navigation">
                                <nav class="navigation post-navigation" role="navigation">
                                    ...
                                    <div class="nav-links">
                                        @foreach($video_others as $key=>$posttwo)
                                        @if($key<2)
                                            <div class="@if($key==0) nav-previous @else nav-next @endif"><a data-id="{{$posttwo->id}}" class="videos_id" href="{{url('/videos/'.$posttwo->video_slug)}}" rel="@if($key==0) prev @else next @endif"><span class="meta-nav" aria-hidden="true">@if($key==0) Bài trước @else Bài tiếp @endif</span> <br><span class="post-title">{{$posttwo->video_name}}</span></a></div>
                                        @endif
                                        @endforeach
                                    </div>
                                </nav>
