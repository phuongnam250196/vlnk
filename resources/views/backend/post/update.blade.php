            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Cập nhật tin tức</h1>
							  	...
							  	<div class="tab-pane container active" id="product_tab_2">
							  		<form  method="POST" enctype="multipart/form-data">
							  			...
							  			<div class="d-flex product_d_flex">
										  	<div class="product_d_flex_title  align-self-center">Tiêu đề</div>
										  	<div class="product_d_flex_input">
												<input type="text" name="post_name" class="form-control" placeholder="VD: Bán hàng online" value="{{$data->post_name}}">
										...
										<div class="d-flex product_d_flex">
										  	...
										  	<div class="product_d_flex_input">
												<input id="img" type="file" name="post_img" class="form-control" style="display: none" onchange="changeImg(this)" value="{{$data->post_img}}">
		                                        <img id="avatar" class="thumbnail" src="{{url('/'.$data->post_img)}}" width="150">
										...
										<div class="d-flex product_d_flex">
										  	...
										  	<div class="product_d_flex_input">
												<textarea name="post_description" class="form-control" cols="30" rows="5">{{$data->post_description}}</textarea>
										...
										<div class="d-flex product_d_flex">
										  	...
										  	<div class="product_d_flex_input">
												<textarea name="post_content" class="form-control" id="post_content" cols="30" rows="4">{{$data->post_content}}</textarea>
										...
										<div class="d-flex product_d_flex">
										  	...
										  	<div class="product_d_flex_input">
												<input type="checkbox" name="post_status" value="1" @if(!empty($data->post_status)) checked @endif> <span>Ẩn bài viết</span>
										  	</div>
										</div>
										<br>
										<br>
