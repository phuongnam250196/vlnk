                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td><img src="{{url('/'.$dat->post_img)}}" width="60" alt=""></td>
                                        <td>{{$dat->post_name}}</td>
                                        <td><div class="post_content_x">{!! strip_tags(preg_replace("/<img[^>]+\>/i", "(image) ", $dat->post_content)) !!}</div></td>
                                        <td>
                                            <a href="{{url('admin/post/update/'.$dat->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></a>
