							  		...
							  		<form method="POST" enctype="multipart/form-data">
							  			<div class="d-flex product_d_flex">
										  	...
										  	<div class="product_d_flex_input">
												<input type="text" name="title" value="{{$data->title}}" class="form-control" placeholder="VD: Ảnh logo webiste">
												@if($errors->has('title'))
										...
										<div class="d-flex product_d_flex">
										  	...
										  	<div class="product_d_flex_input">
												<input type="url" name="link" value="{{$data->link}}" class="form-control" placeholder="VD: https://vlnk.com.vn">
												@if($errors->has('link'))
										...
										<div class="d-flex product_d_flex">
										  	...
										  	<div class="product_d_flex_input">
												<input id="img" type="file" name="image" class="form-control" style="display: none" onchange="changeImg(this)"  value="{{$data->image}}">
		                                        <img id="avatar" class="thumbnail" src="{{url('/'.$data->image)}}" width="150">
												@if($errors->has('image'))
										...
										<div class="d-flex product_d_flex">
										  	...
										  	<div class="product_d_flex_input">
												<input type="checkbox" name="status" value="1" @if(!empty($data->status)) checked="" @endif> <span>Ẩn / Hiện</span>
										  	</div>
										</div>
										<br>
										<br>
